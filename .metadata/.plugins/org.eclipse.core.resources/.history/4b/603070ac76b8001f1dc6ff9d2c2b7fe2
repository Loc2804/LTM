...
<body>
     ...
     <div class="content">
        ...
        <div class="content">
          ...
          <form action="UserController" method="POST">
            ...
            <input type="text" id="username" name="username" class="input-field" placeholder="Enter your username" required onblur="checkUsername()">
    ...
    <script type="text/javascript">
	    ...
	    function checkUsername() {
	        ...
	        var idnv = document.getElementById('username').value;
                ...
                <td>
                	<div class="icon-action">
                		<button class="action-icons edit"  
                			onclick="fillInfo('<%= u.getId() %>','<%=u.getUsername() %>','<%=u.getPassword() %>','<%=u.getFullName() %>',
                			'<%=u.getPhonenumber() %>','<%=u.getAddress() %>','<%=u.getAge() %>',
                			'<%=u.getGender() %>','<%=u.getRole().getId() %>')"
                		>
	...
	<script type="text/javascript">
		function fillInfo(id,username, password, fullName, phone, add, age,gender,role) {
		...
		function resetForm() {
		    document.querySelector('input[name="username"]').readOnly = false;
		    document.querySelector('input[name="password"]').readOnly = false;
		}
		function setId(id){
