...
<body>
     ...
     <div class="content">
        ...
        <div class="content">
          ...
          <form action="RoleController" method="POST">
            ...
            <input type="text" id="name" name="name" class="input-field" placeholder="Enter role name" required onblur="checkName()">
    ...
    <%
	    List<Role> list = (List<Role>) session.getAttribute("listRole");
